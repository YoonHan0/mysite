										...
										<tr>
											...
											<c:choose>
												<c:when test='${vo.depth eq 0 }'>
													<td style="text-align: left; padding-left: 0px"><a
														href="${pageContext.request.contextPath }/board?a=viewpage&&no=${vo.no}&&userNo=${vo.userNo}">${vo.title }</a>
													</td>
												</c:when>
											...
											<td>	
												<c:if test='${authUser.no == vo.userNo}'>
													<a href="${pageContext.request.contextPath }/board?a=delete&&no=${vo.no }"><img
